function onCreate()
	makeLuaSprite('sky','forest/skySunset',-960.3,-456.05)
	addLuaSprite('sky',false)

	makeLuaSprite('clouds','forest/cloudsSunset',-640.3,-330.05)
	...
	makeLuaSprite('base','forest/forestSunset',-960.3,-456.05)
	...
	makeLuaSprite('bushes','forest/overlaySunset',-940.3,-446.05)
